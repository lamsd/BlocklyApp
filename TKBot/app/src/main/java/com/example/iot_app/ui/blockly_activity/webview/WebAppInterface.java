...
//        ff 55 07 00 02 02 00 00 00 00
    ...
    @JavascriptInterface
    public boolean buttonmu(String port) {
        BlocklyActivity.hc05Send("ff5504000111" + port);
        if (port.equals("01")) {
            Log.d(TAG, " Button 111: " + port + " " + BlocklyActivity.buttonData1);
            return BlocklyActivity.buttonData1;
        } else if (port.equals("02")) {
            Log.d(TAG, " Button 222: " + port + " " + BlocklyActivity.buttonData2);
            return BlocklyActivity.buttonData2;
        } else if (port.equals("03")) {
            Log.d(TAG, " Button 333: " + port + " " + BlocklyActivity.buttonData3);
            return BlocklyActivity.buttonData3;
        } else if (port.equals("05")) {
            Log.d(TAG, " Button 555: " + port + " " + BlocklyActivity.buttonData5);
            return BlocklyActivity.buttonData5;
        } else if (port.equals("06")) {
            Log.d(TAG, " Button 666: " + port + " " + BlocklyActivity.buttonData6);
            return BlocklyActivity.buttonData6;
        } else if (port.equals("07")) {
            Log.d(TAG, " Button 777: " + port + " " + BlocklyActivity.buttonData7);
            return BlocklyActivity.buttonData7;
        } else if (port.equals("08")) {
            Log.d(TAG, " Button 888: " + port + " " + BlocklyActivity.buttonData8);
            return BlocklyActivity.buttonData8;
        } else {
            return BlocklyActivity.buttonData;
        }
    }
    ...
    public boolean lineFollow2(String port, String s1, String s2) {
        ...
        if (s1.equals("black") && s2.equals("black")) {
            x1 = "40";
            x2 = "40";
        } else if (s1.equals("black") && s2.equals("white")) {

            x1 = "00";
            x2 = "40";
        } else if (s1.equals("white") && s2.equals("black")) {
            x1 = "80";
            x2 = "3f";
        } else if (s1.equals("white") && s2.equals("white")) {
            x1 = "00";
            x2 = "00";
        }
        if (port.equals("02")) {
