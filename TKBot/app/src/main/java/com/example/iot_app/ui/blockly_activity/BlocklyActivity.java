...
public class BlocklyActivity extends RainbowHatBlocklyBaseActivity {
    ...
    //data
    public static int sensorData7 = 0;
    public static int ultradata1 = 0;
    public static int ultradata2 = 0;
    public static int ultradata3 = 0;
    public static int ultradata4 = 0;
    public static int ultradata5 = 0;
    ...
    public static boolean touchData2 = false;
    public static boolean touchData3 = false;
    public static boolean touchData4 = false;
    public static boolean touchData5 = false;
    public static boolean touchData6 = false;

    public static int temperatureData = 0;
    public static int temperatureData1 = 0;
    public static int temperatureData2 = 0;
    public static int temperatureData3 = 0;
    public static int temperatureData4 = 0;
    public static int temperatureData5 = 0;
    public static int temperatureData6 = 0;

    public static int potenlData = 0;
    public static int potenldata1 = 0;
    public static int potenldata2 = 0;
    public static int potenldata3 = 0;

    public static boolean lineValue = false;
    public static String lineValueS12 = "";
    public static String lineValueS11 = "";
    public static String lineValueS22 = "";
    public static String lineValueS21 = "";
    public static String lineValueS32 = "";
    public static String lineValueS31 = "";
    public static String lineValueS42 = "";
    public static String lineValueS41 = "";
    public static String lineValueS52 = "";
    public static String lineValueS51 = "";
    public static String lineValueS62 = "";
    public static String lineValueS61 = "";
...
//                finish();
                ...
                Log.d("hddd", "ghghhghhhdhdhdhhdhdhdhdhdhhdhdhdhdhddddff");
